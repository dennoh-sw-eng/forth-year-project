 ...
 * @author User
 */
public class DispatchDrugs extends javax.swing.JFrame {

    /**
     * Creates new form DispatchDrugs
     */
    public DispatchDrugs() {
        initComponents();
    }
    ...
    try {
        ...
        JOptionPane.showMessageDialog(this, dispatchQuantity + " pieces of " + drugName + " dispatched to " + branchName);
    ...
    public boolean dispatchDrugs (){
        ...
        Date uDispatchDate = date_dispatchDate.getDate();
        Date uExpiryDate = date_expiryDate.getDate();
        
        //covert date into long value
        long l1 = uDispatchDate.getTime();
        long l2 = uExpiryDate.getTime();
        
        //covert java.util date to java.sql date
        java.sql.Date sqlDispatchDate = new java.sql.Date(l1);
        java.sql.Date sqlExpiryDate = new java.sql.Date(l2);
        
        try{
            Connection con = DBConnection.getConnection();
            String sql = "insert into dispatchdrugs(drugId, drugName, branchId, branch, quantityQ, dispatch, expiry, statusT) values(?,?,?,?,?,?,?,?)";
            ...
            pst.setDate(7, sqlExpiryDate);
            pst.setString(8, "delivered");
    ...
    private void initComponents() {
        ...
        date_expiryDate = new com.toedter.calendar.JDateChooser();
        ...
        txt_drugError.setBackground(new java.awt.Color(153, 204, 255));
        ...
        jLabel14.setText("Dispatch Drug");
        ...
        jLabel10.setText("Dispatch Date:");
        jPanel3.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 310, 120, 20));
        jPanel3.add(date_expiryDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 350, 150, 40));

        jLabel16.setFont(new java.awt.Font("Perpetua", 1, 18)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(0, 153, 153));
        jLabel16.setText("Expiry Date:");
        jPanel3.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 360, 100, 20));
        ...
        rSMaterialButtonCircle1.setText("Dispatch");
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 0, 310, 480));

        jPanel1.setBackground(new java.awt.Color(0, 153, 153));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 0, 10, 480));
        ...
        setSize(new java.awt.Dimension(984, 504));
    ...
    private void rSMaterialButtonCircle1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSMaterialButtonCircle1ActionPerformed
        ...
        if(lb_quantity.getText().equals("0")){
            JOptionPane.showMessageDialog(this, "Cannot dispatch zero stock");
            
        }else{
            if (dispatchDrugs() == true){
            JOptionPane.showMessageDialog(this, "drugs dispatched");
        }else{
        JOptionPane.showMessageDialog(this, "dispatch error");
    }
            updateQuantity();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DispatchDrugs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DispatchDrugs().setVisible(true);
            }
        });
    }
    ...
    private com.toedter.calendar.JDateChooser date_expiryDate;
